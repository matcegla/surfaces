...
struct Uniform {
  ...
  void
  operator=(const glm::vec2 &x); // NOLINE(misc-unconventional-assign-operator)
  void
  operator=(const glm::vec3 &x); // NOLINT(misc-unconventional-assign-operator)
  void
  operator=(const glm::mat4 &x); // NOLINT(misc-unconventional-assign-operator)
  int id;
};
struct Program {
  Program();
...
struct Texture {
  ...
  void image2D(GLenum target, GLint level, GLint internalFormat, GLsizei width,
...
struct RBO {
  ...
  void bind(GLenum target);
  void unbind(GLenum target);
  void storage(GLenum target, GLenum internalFormat, GLsizei width,
               GLsizei height);
  unsigned id;
};
struct FBO {
  ...
  void bind(GLenum target);
  void unbind(GLenum target);
  void texture2D(GLenum target, GLenum attachment, GLenum textarget,
                 Texture &texture, GLint level);
  void renderbuffer(GLenum target, GLenum attachment, GLenum renderbuffertarget,
                    RBO &renderbuffer);
